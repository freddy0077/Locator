...
import com.evergreen.locator.activity.MainActivity;
import com.evergreen.locator.customview.CustomInfoWindowGoogleMap;
import com.evergreen.locator.data.AppConstant;
import com.evergreen.locator.data.LoadStoreDataFromSheet;
...
import com.evergreen.locator.utility.PermissionUtils;
import com.evergreen.locator.utility.maputility.GPSTracker;
...
public class MyMapsFragment extends Fragment implements OnMapReadyCallback,
    ...
    private void getLocationByBranchName(int i) {
        double ltd = Double.valueOf(allStorelList.get(i).getLocation().getLat());
        double lng = Double.valueOf(allStorelList.get(i).getLocation().getLng());
